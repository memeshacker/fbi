...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     MEMES HACKERS
    Name       Facebook Information
    Version    Full Version
    Date       27/08/2021 
    InstaID    memeshackers
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'memeshackers' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'memeshackers' + W +'/' + R +'Bot ' + W + '>> ')
...
def main():
  ...
  try:
	cek = raw_input(R + 'memeshackers' + W +' >> ')
	...
	if cek.lower() == 'get_data':
		...
		print '\n' + '[*] Generate Access token facebook [*]'.center(44) + '\n'
		print '[Warn] please turn on your VPN(USA) before using this feature !!!'
		id()
